...
public class SSSimpleStatementPrinter extends SSPrinter {
    ...
    private BigDecimal getValueForGroup(String group, int number){
        ...
        switch(number){
            case  1: iValues = iDebetMinusCreditSum; break;
            case  2: iValues = iDebetMinusCreditSum; break;
            case  3: iValues = iCreditMinusDebetSum; break;
            case  4: iValues = iCreditMinusDebetSum; break;
            case  5: iValues = iCreditMinusDebetSum; break;
            case  6: iValues = iCreditMinusDebetSum; break;
            case  7: iValues = iCreditMinusDebetSum; break;
            case  8: iValues = iCreditMinusDebetSum; break;
            case  9: iValues = iCreditMinusDebetSum; break;
            case 10: iValues = iDebetMinusCreditSum; break;
            case 11: iValues = iCreditMinusDebetSum; break;
            default: return new BigDecimal(0);
        }

        if(group.equals("B11")) return null;
        if(group.equals("B12")) return null;

        if(group.equals("B10")){
            BigDecimal iSumForAccounts = getSumForAccounts(iValues, group);
            iSumForAccounts = iSumForAccounts.add(getSumForAccounts(iValues, "U1", "U2", "U3", "U4"));
    ...
    private BigDecimal getSumForGroup(String group, int number){
        ...
        if(group.equals("B9") ) return getSumForAccounts(iDebetMinusCreditSum, "B1", "B2", "B3", "B4", "B5", "B6", "B7", "B8", "B9");
        if(group.equals("B16")) return getSumForAccounts(iCreditMinusDebetSum, "B10", "B13", "B14", "B15", "B16", "U1", "U2", "U3", "U4");
        ...
        for (SSAccount iAccount : iAccounts) {
            if( hasReportCode(iAccount,  iReportCodes) ) {
                ...
                if(iInbalanceForAccount != null){
                    if( hasReportCode(iAccount,  "B10", "B13", "B14", "B15", "B16", "U1", "U2", "U3", "U4"))
