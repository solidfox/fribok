...
public class SSCreditinvoicePrinter extends SSPrinter {
    ...
    private void addParameters(){
        ...
        SSCustomer iCustomer = iCreditInvoice.getCustomer( SSDB.getInstance().getCustomers() );
        ...
        addParameter("creditinvoice.hasdiscount"   , SSInvoiceMath.hasDiscount(iCreditInvoice));

        addParameter("creditinvoice.deliveryadress.name"    , iCreditInvoice.getDeliveryAddress().getName() );
        addParameter("creditinvoice.deliveryadress.address1", iCreditInvoice.getDeliveryAddress().getAddress1() );
        addParameter("creditinvoice.deliveryadress.address2", iCreditInvoice.getDeliveryAddress().getAddress2() );
        addParameter("creditinvoice.deliveryadress.zipcode" , iCreditInvoice.getDeliveryAddress().getZipCode() );
        addParameter("creditinvoice.deliveryadress.city"    , iCreditInvoice.getDeliveryAddress().getCity() );
        addParameter("creditinvoice.deliveryadress.country" , iCreditInvoice.getDeliveryAddress().getCountry() );

        addParameter("creditinvoice.invoiceadress.name"    , iCreditInvoice.getInvoiceAddress().getName() );
        addParameter("creditinvoice.invoiceadress.address1", iCreditInvoice.getInvoiceAddress().getAddress1() );
        addParameter("creditinvoice.invoiceadress.address2", iCreditInvoice.getInvoiceAddress().getAddress2() );
        addParameter("creditinvoice.invoiceadress.zipcode" , iCreditInvoice.getInvoiceAddress().getZipCode() );
        addParameter("creditinvoice.invoiceadress.city"    , iCreditInvoice.getInvoiceAddress().getCity() );
        addParameter("creditinvoice.invoiceadress.country" , iCreditInvoice.getInvoiceAddress().getCountry() );
        ...
        addParameter("creditinvoice.delayinterest"            , iCreditInvoice.getDelayInterest () , true);
        ...
        if(iInvoice != null && iInvoice.getOCRNumber() != null){
            ...
            addParameter("creditinvoice.invoicenumber" , iCreditInvoice.getCreditingNr(), true );
        }
