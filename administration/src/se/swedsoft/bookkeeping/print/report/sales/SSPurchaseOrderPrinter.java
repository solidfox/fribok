...
public class SSPurchaseOrderPrinter extends SSPrinter {
    ...
    public SSPurchaseOrderPrinter(SSPurchaseOrder iPurchaseOrder, Locale iLocale){
        ...
        ResourceBundle iBundle = ResourceBundle.getBundle("se.swedsoft.bookkeeping.resources.purchaseorderrreport", iLocale);
    ...
    private void addParameters(){
       SSNewCompany iCompany = SSDB.getInstance().getCurrentCompany();
        ...
        SSSupplier iSupplier = iPurchaseOrder.getSupplier( SSDB.getInstance().getSuppliers() );
    ...
    protected SSDefaultTableModel getModel() {
        final SSPrinter iPrinter = new SSPurchaseOrderPrinter.SSRowReport(  );
